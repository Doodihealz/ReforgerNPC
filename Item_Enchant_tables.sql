...
-- Dumping data for table acore_world.item_enchantment_random_tiers: ~474 rows (approximately)
INSERT IGNORE INTO `item_enchantment_random_tiers` (`enchantID`, `tier`, `class`, `exclusiveSubClass`) VALUES
	(1, 1, 'ANY', NULL),
	(3, 1, 'ANY', NULL),
	(524, 1, 'ANY', NULL),
	(36, 1, 'ANY', NULL),
...
-- Dumping data for table acore_world.item_enchantment_template: ~27,874 rows (approximately)
